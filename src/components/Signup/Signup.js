    ...
    <div className="flex flex-col justify-center items-center" style={{height: "100vh"}}>
      <div style={{minWidth:"25vw"}}>
        <div className="px-16 py-16 neo">
          <h2 className="text-center mb-4 text-3xl font-bold">Sign Up</h2>
          ...
          <div id="email" className="flex flex-col">
            ...
            <div id="password-confirm" className="flex flex-col">
              <label htmlFor="password-confirm" className="text-2xl pb-4">Password Confirmation</label>
              <input type="password" name="password-confirm" ref={passwordConfirmRef} required className="p-5 rounded-full outline-0 border-2 border-gray-300"/>
            </div>
